...
const AAVE_ARBITRUM_SUBGRAPH_URL =
  "https://api.thegraph.com/subgraphs/id/Qmdn5hAZZj3wmWVuksXHtua3E6aWftCDeTFcW8YQ8Lu6pB";
...
const fetchAPYData = async () => {
  try {
    console.log("Fetching data for USDC pool on Arbitrum...");

    const response = await axios.post(AAVE_ARBITRUM_SUBGRAPH_URL, { query });
